...
<body class="px-4 py-8 md:px-6 md:py-10 max-w-7xl mx-auto">
  <header class="text-center mb-12">
    <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-2">{company_name} – Special Situation Infographic</h1>
    <p class="text-sm text-gray-500">Generated by MaSh Analytics GenAI Platform</p>
  </header>
